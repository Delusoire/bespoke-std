...
const MSI = await import("/modules/Delusoire/stdlib/index.js")
HU.visited.clear()
...
type PlatformAutoGen = {
		...
		hpto: {
			...
			hptoApi: {
				...
				eventSender: {
						...
						storageManager: {
							...
							storage: {
								adapter: {
									clear: () => undefined;
									getItem: () => null;
									getKeys: () => ReturnType<PlatformAutoGen["getAdManagers"]>["adStateReporter"]["focusState"]["listeners"];
					...
					essLastSent: {
						...
						toString: () => any;
						toTimeString: () => any;
						toUTCString: ReturnType<PlatformAutoGen["getAdManagers"]>["hpto"]["hptoApi"]["eventSender"]["essLastSent"]["toGMTString"];
						valueOf: () => any;
					};
					eventsManager: {
						addEvent: (a) => any;
						...
						removeEvents: () => any;
						storageManager: ReturnType<PlatformAutoGen["getAdManagers"]>["hpto"]["hptoApi"]["eventSender"]["droppedEventsTracker"]["storageManager"];
					};
					finalFlush: () => any;
					flush: () => Promise<any>;
					fullESS2NALastSent: ReturnType<PlatformAutoGen["getAdManagers"]>["hpto"]["hptoApi"]["eventSender"]["essLastSent"];
					getEvents: () => any;
					...
					transport: {
						...
						_connectionObserver: {
							_dispatchFromStore: ReturnType<PlatformAutoGen["getAdManagers"]>["hpto"]["hptoApi"]["eventSender"]["_dispatchFromStore"];
							_listeners: {
								beforeunload: ReturnType<PlatformAutoGen["getAdManagers"]>["adStateReporter"]["focusState"]["listeners"];
								offline: ReturnType<PlatformAutoGen["getAdManagers"]>["adStateReporter"]["focusState"]["listeners"];
								online: ReturnType<PlatformAutoGen["getAdManagers"]>["adStateReporter"]["focusState"]["listeners"];
							};
							_metaListeners: { add: {}; remove: {} };
							_navigator: {
								appCodeName: string;
								...
								language: string;
								languages: ReturnType<PlatformAutoGen["getAdManagers"]>["adStateReporter"]["focusState"]["listeners"];
								...
								userAgent: string;
								userAgentData: {
									brands: ReturnType<PlatformAutoGen["getAdManagers"]>["adStateReporter"]["focusState"]["listeners"];
							...
							addListener: ReturnType<PlatformAutoGen["getAdManagers"]>["hpto"]["hptoApi"]["eventSender"]["addListener"];
							addListeners: ReturnType<PlatformAutoGen["getAdManagers"]>["hpto"]["hptoApi"]["eventSender"]["addListeners"];
							createEvent: ReturnType<PlatformAutoGen["getAdManagers"]>["hpto"]["hptoApi"]["eventSender"]["createEvent"];
							emit: ReturnType<PlatformAutoGen["getAdManagers"]>["hpto"]["hptoApi"]["eventSender"]["emit"];
							emitAndWait: ReturnType<PlatformAutoGen["getAdManagers"]>["hpto"]["hptoApi"]["eventSender"]["emitAndWait"];
							emitEvent: ReturnType<PlatformAutoGen["getAdManagers"]>["hpto"]["hptoApi"]["eventSender"]["emitEvent"];
							emitEventAndWait: ReturnType<PlatformAutoGen["getAdManagers"]>["hpto"]["hptoApi"]["eventSender"]["emitEventAndWait"];
							emitEventSync: ReturnType<PlatformAutoGen["getAdManagers"]>["hpto"]["hptoApi"]["eventSender"]["emitEventSync"];
							emitSync: ReturnType<PlatformAutoGen["getAdManagers"]>["hpto"]["hptoApi"]["eventSender"]["emitSync"];
							isOnline: () => any;
							on: ReturnType<PlatformAutoGen["getAdManagers"]>["hpto"]["hptoApi"]["eventSender"]["on"];
							onAddListener: ReturnType<PlatformAutoGen["getAdManagers"]>["hpto"]["hptoApi"]["eventSender"]["onAddListener"];
							onRemoveListener: ReturnType<PlatformAutoGen["getAdManagers"]>["hpto"]["hptoApi"]["eventSender"]["onRemoveListener"];
							once: ReturnType<PlatformAutoGen["getAdManagers"]>["hpto"]["hptoApi"]["eventSender"]["once"];
							proxyEmit: ReturnType<PlatformAutoGen["getAdManagers"]>["hpto"]["hptoApi"]["eventSender"]["proxyEmit"];
							proxyEmitAll: ReturnType<PlatformAutoGen["getAdManagers"]>["hpto"]["hptoApi"]["eventSender"]["proxyEmitAll"];
							proxyEmitAllSync: ReturnType<PlatformAutoGen["getAdManagers"]>["hpto"]["hptoApi"]["eventSender"]["proxyEmitAllSync"];
							proxyEmitSync: ReturnType<PlatformAutoGen["getAdManagers"]>["hpto"]["hptoApi"]["eventSender"]["proxyEmitSync"];
							removeAllListeners: ReturnType<PlatformAutoGen["getAdManagers"]>["hpto"]["hptoApi"]["eventSender"]["removeAllListeners"];
							removeListener: ReturnType<PlatformAutoGen["getAdManagers"]>["hpto"]["hptoApi"]["eventSender"]["removeListener"];
							removeListeners: ReturnType<PlatformAutoGen["getAdManagers"]>["hpto"]["hptoApi"]["eventSender"]["removeListeners"];
						};
						_counter: {
							_baseTime: number;
							_ceiling: number;
						...
						_listeners: {
							access_token: ReturnType<PlatformAutoGen["getAdManagers"]>["adStateReporter"]["focusState"]["listeners"];
							authenticated: ReturnType<PlatformAutoGen["getAdManagers"]>["adStateReporter"]["focusState"]["listeners"];
							authentication_failed: ReturnType<PlatformAutoGen["getAdManagers"]>["adStateReporter"]["focusState"]["listeners"];
							connected: ReturnType<PlatformAutoGen["getAdManagers"]>["adStateReporter"]["focusState"]["listeners"];
							disconnected: ReturnType<PlatformAutoGen["getAdManagers"]>["adStateReporter"]["focusState"]["listeners"];
							endpoints_resolved: ReturnType<PlatformAutoGen["getAdManagers"]>["adStateReporter"]["focusState"]["listeners"];
							logged_out: ReturnType<PlatformAutoGen["getAdManagers"]>["adStateReporter"]["focusState"]["listeners"];
							offline: ReturnType<PlatformAutoGen["getAdManagers"]>["adStateReporter"]["focusState"]["listeners"];
							online: ReturnType<PlatformAutoGen["getAdManagers"]>["adStateReporter"]["focusState"]["listeners"];
							reconnected: ReturnType<PlatformAutoGen["getAdManagers"]>["adStateReporter"]["focusState"]["listeners"];
							reconnecting: ReturnType<PlatformAutoGen["getAdManagers"]>["adStateReporter"]["focusState"]["listeners"];
						};
						_metaListeners: {
							add: {
								authenticated: ReturnType<PlatformAutoGen["getAdManagers"]>["adStateReporter"]["focusState"]["listeners"];
								connected: ReturnType<PlatformAutoGen["getAdManagers"]>["adStateReporter"]["focusState"]["listeners"];
								connection_id: ReturnType<PlatformAutoGen["getAdManagers"]>["adStateReporter"]["focusState"]["listeners"];
							};
							remove: {
								authenticated: ReturnType<PlatformAutoGen["getAdManagers"]>["adStateReporter"]["focusState"]["listeners"];
								connected: ReturnType<PlatformAutoGen["getAdManagers"]>["adStateReporter"]["focusState"]["listeners"];
						...
						_pluginMediator: {
							_dispatchFromStore: ReturnType<PlatformAutoGen["getAdManagers"]>["hpto"]["hptoApi"]["eventSender"]["_dispatchFromStore"];
							_listeners: {
								plugin_connection_info: ReturnType<PlatformAutoGen["getAdManagers"]>["adStateReporter"]["focusState"]["listeners"];
								plugin_disconnected: ReturnType<PlatformAutoGen["getAdManagers"]>["adStateReporter"]["focusState"]["listeners"];
								plugin_message: ReturnType<PlatformAutoGen["getAdManagers"]>["adStateReporter"]["focusState"]["listeners"];
								transport_authenticate: ReturnType<PlatformAutoGen["getAdManagers"]>["adStateReporter"]["focusState"]["listeners"];
								transport_before_process_request: ReturnType<PlatformAutoGen["getAdManagers"]>["adStateReporter"]["focusState"]["listeners"];
								transport_before_send_request: ReturnType<PlatformAutoGen["getAdManagers"]>["adStateReporter"]["focusState"]["listeners"];
								transport_connect: ReturnType<PlatformAutoGen["getAdManagers"]>["adStateReporter"]["focusState"]["listeners"];
								transport_disconnect: ReturnType<PlatformAutoGen["getAdManagers"]>["adStateReporter"]["focusState"]["listeners"];
							};
							_metaListeners: {
								add: {
									transport_authenticate: ReturnType<PlatformAutoGen["getAdManagers"]>["adStateReporter"]["focusState"]["listeners"];
						...
						_plugins: {
							dealer: {
								_dealer: {
									...
									_listeners: {
										connection_id: ReturnType<PlatformAutoGen["getAdManagers"]>["adStateReporter"]["focusState"]["listeners"];
										disconnected: ReturnType<PlatformAutoGen["getAdManagers"]>["adStateReporter"]["focusState"]["listeners"];
										error: ReturnType<PlatformAutoGen["getAdManagers"]>["adStateReporter"]["focusState"]["listeners"];
										message: ReturnType<PlatformAutoGen["getAdManagers"]>["adStateReporter"]["focusState"]["listeners"];
										request: ReturnType<PlatformAutoGen["getAdManagers"]>["adStateReporter"]["focusState"]["listeners"];
									};
									_metaListeners: { add: {}; remove: {} };
								...
								_mediator: ReturnType<PlatformAutoGen["getAdManagers"]>["hpto"]["hptoApi"]["eventSender"]["transport"]["_pluginMediator"];
							...
							"desktop-lifecycle-plugin": {
								...
								_transport: ReturnType<PlatformAutoGen["getAdManagers"]>["hpto"]["hptoApi"]["eventSender"]["transport"];
								attach: (a) => any;
								detach: (a) => any;
								name: string;
					...
					uploaders: {
						authorized: {
							...
							_endpoint: string;
							_listeners: {
								upload_failed: ReturnType<PlatformAutoGen["getAdManagers"]>["adStateReporter"]["focusState"]["listeners"];
								upload_request_failed: ReturnType<PlatformAutoGen["getAdManagers"]>["adStateReporter"]["focusState"]["listeners"];
								upload_succeeded: ReturnType<PlatformAutoGen["getAdManagers"]>["adStateReporter"]["focusState"]["listeners"];
							};
							_metaListeners: { add: {}; remove: {} };
						...
						unauthorized: ReturnType<PlatformAutoGen["getAdManagers"]>["hpto"]["hptoApi"]["eventSender"]["uploaders"]["authorized"];
					};
				...
				webApi: {
					...
					spotifyTransport: {
						...
						_accessToken: string;
						_globalRequestHeaders: ReturnType<PlatformAutoGen["getAdManagers"]>["adStateReporter"]["focusState"]["listeners"];
						_locale: string;
						_market: string;
						accessToken: string;
						build: () => any;
						globalRequestHeaders: ReturnType<PlatformAutoGen["getAdManagers"]>["adStateReporter"]["focusState"]["listeners"];
						locale: string;
						market: string;
			...
			visibilityObserver: {
				...
				intersectionObserver: {
					...
					scrollMargin: string;
					takeRecords: () => any;
					thresholds: ReturnType<PlatformAutoGen["getAdManagers"]>["adStateReporter"]["focusState"]["listeners"];
	...
	getAudiobooksPremiumConsumptionCapObserverAPI: () => {
		_playerApi: {
			...
			_contextPlayer: {
				...
				skipPrev: (a) => any;
				stop: (a) => any;
				transport: ReturnType<PlatformAutoGen["getAudiobooksPremiumConsumptionCapObserverAPI"]>["_playerApi"]["_collection"]["transport"];
				updateContext: (a) => any;
			...
			_contextualShuffle: {
				_indexedDbAPI: {
					...
					_events: {
						_emitter: ReturnType<PlatformAutoGen["getAdManagers"]>["hpto"]["hptoApi"]["eventSender"]["transport"]["_pluginMediator"];
						addListener: (a, b) => any;
						emit: (a) => any;
						emitSync: (a) => any;
						onAddListener: (a) => any;
			...
			_cosmos: {
				...
				resolve: (a, b, c) => any;
				resolver: {
					cancel: ReturnType<PlatformAutoGen["getAudiobooksPremiumConsumptionCapObserverAPI"]>["_playerApi"]["_collection"]["transport"]["cancel"];
					onFailure: (a, b, c) => any;
					onSuccess: (a, b, c) => any;
					resolve: (a, b) => any;
					send: ReturnType<PlatformAutoGen["getAudiobooksPremiumConsumptionCapObserverAPI"]>["_playerApi"]["_collection"]["transport"]["send"];
				};
				sub: (a, b) => any;
			};
			_defaultFeatureVersion: string;
			_events: {
				_client: ReturnType<PlatformAutoGen["getAudiobooksPremiumConsumptionCapObserverAPI"]>["_playerApi"]["_contextPlayer"];
				_emitter: ReturnType<PlatformAutoGen["getAdManagers"]>["hpto"]["hptoApi"]["eventSender"]["transport"]["_pluginMediator"];
			...
			_queue: {
				_client: ReturnType<PlatformAutoGen["getAudiobooksPremiumConsumptionCapObserverAPI"]>["_playerApi"]["_contextPlayer"];
				_events: ReturnType<PlatformAutoGen["getAudiobooksPremiumConsumptionCapObserverAPI"]>["_playerApi"]["_events"];
				_queue: {
					nextTracks: ReturnType<PlatformAutoGen["getAdManagers"]>["adStateReporter"]["focusState"]["listeners"];
					prevTracks: ReturnType<PlatformAutoGen["getAdManagers"]>["adStateReporter"]["focusState"]["listeners"];
					queueRevision: string;
					track: {
						blocked: ReturnType<PlatformAutoGen["getAdManagers"]>["adStateReporter"]["focusState"]["listeners"];
						contextTrack: {
							metadata: {
						...
						provider: string;
						removed: ReturnType<PlatformAutoGen["getAdManagers"]>["adStateReporter"]["focusState"]["listeners"];
					};
				};
				_queueState: {
					current: {
			...
			_state: {
				...
				previousItems: ReturnType<PlatformAutoGen["getAdManagers"]>["adStateReporter"]["focusState"]["listeners"];
				repeat: number;
				restrictions: {
					canPause: boolean;
					canResume: boolean;
					...
					disallowPausingReasons: ReturnType<PlatformAutoGen["getAdManagers"]>["adStateReporter"]["focusState"]["listeners"];
					disallowResumingReasons: ReturnType<PlatformAutoGen["getAdManagers"]>["adStateReporter"]["focusState"]["listeners"];
					disallowSeekingReasons: ReturnType<PlatformAutoGen["getAdManagers"]>["adStateReporter"]["focusState"]["listeners"];
					disallowSkippingNextReasons: ReturnType<PlatformAutoGen["getAdManagers"]>["adStateReporter"]["focusState"]["listeners"];
					disallowSkippingPreviousReasons: ReturnType<PlatformAutoGen["getAdManagers"]>["adStateReporter"]["focusState"]["listeners"];
					disallowTogglingRepeatContextReasons: ReturnType<PlatformAutoGen["getAdManagers"]>["adStateReporter"]["focusState"]["listeners"];
					disallowTogglingRepeatTrackReasons: ReturnType<PlatformAutoGen["getAdManagers"]>["adStateReporter"]["focusState"]["listeners"];
					disallowTogglingShuffleReasons: ReturnType<PlatformAutoGen["getAdManagers"]>["adStateReporter"]["focusState"]["listeners"];
					disallowTransferringPlaybackReasons: ReturnType<PlatformAutoGen["getAdManagers"]>["adStateReporter"]["focusState"]["listeners"];
				};
				sessionId: string;
				shuffle: boolean;
		...
		_showApi: {
			...
			_show_service_client: ReturnType<PlatformAutoGen["getAudiobooksPremiumConsumptionCapObserverAPI"]>["_showApi"]["_events"]["_show_client"];
			capabilities: {
				canFilter: boolean;
		...
		currentPlayerState: ReturnType<PlatformAutoGen["getAudiobooksPremiumConsumptionCapObserverAPI"]>["_playerApi"]["_state"];
	...
	getAuthorizationAPI: () => {
		...
		_plugin: ReturnType<PlatformAutoGen["getAdManagers"]>["hpto"]["hptoApi"]["eventSender"]["transport"]["_plugins"]["desktop-lifecycle-plugin"];
		_state: {
	...
	getConnectAPI: () => {
		...
		state: {
			activeDevice: {
				...
				id: string;
				incarnation: {
					available: ReturnType<PlatformAutoGen["getAdManagers"]>["adStateReporter"]["focusState"]["listeners"];
					preferred: undefined;
				};
				isActive: boolean;
	...
	getCurationAPI: () => {
		_libraryAPI: {
			_builder: ReturnType<PlatformAutoGen["getAdManagers"]>["hpto"]["hptoApi"]["webApi"]["spotifyTransport"];
			_cache: Map<any, any>;
			_collection: ReturnType<PlatformAutoGen["getAudiobooksPremiumConsumptionCapObserverAPI"]>["_playerApi"]["_collection"];
			_currentUsername: string;
			_events: {
				_aggregator: ReturnType<PlatformAutoGen["getAudiobooksPremiumConsumptionCapObserverAPI"]>["_showApi"]["_events"]["_aggregator"];
				_cache: Map<any, any>;
				_cancellables: {
		...
		_playlistAPI: {
			...
			_playlistServiceClient: ReturnType<
				PlatformAutoGen["getAudiobooksPremiumConsumptionCapObserverAPI"]
			>["_playerApi"]["_playlistResyncerAPI"]["_playlistServiceClient"];
			_resyncAPI: ReturnType<PlatformAutoGen["getAudiobooksPremiumConsumptionCapObserverAPI"]>["_playerApi"]["_playlistResyncerAPI"];
			...
			getPlaylistQuery: () => {
				...
				attributeFilter: ReturnType<PlatformAutoGen["getAdManagers"]>["adStateReporter"]["focusState"]["listeners"];
				boolPredicates: ReturnType<PlatformAutoGen["getAdManagers"]>["adStateReporter"]["focusState"]["listeners"];
				descriptorFilter: ReturnType<PlatformAutoGen["getAdManagers"]>["adStateReporter"]["focusState"]["listeners"];
				group: boolean;
				...
				supportedPlaceholderTypes: ReturnType<PlatformAutoGen["getAdManagers"]>["adStateReporter"]["focusState"]["listeners"];
				textFilter: string;
		...
		events: {
			...
			addListener: ReturnType<
				PlatformAutoGen["getAudiobooksPremiumConsumptionCapObserverAPI"]
			>["_playerApi"]["_contextualShuffle"]["_indexedDbAPI"]["_events"]["addListener"];
			aggregator: ReturnType<PlatformAutoGen["getAudiobooksPremiumConsumptionCapObserverAPI"]>["_showApi"]["_events"]["_aggregator"];
			cache: Map<any, any>;
			emit: ReturnType<
				PlatformAutoGen["getAudiobooksPremiumConsumptionCapObserverAPI"]
			>["_playerApi"]["_contextualShuffle"]["_indexedDbAPI"]["_events"]["emit"];
	...
	getEqualizerAPI: () => {
		...
		localStorageAPI: {
			...
			items: {
				...
				"yblp9ylse3i4cdx2klsq1xnlx:ylx-expanded-folders": ReturnType<PlatformAutoGen["getAdManagers"]>["adStateReporter"]["focusState"]["listeners"];
	...
	getPlayHistoryAPI: () => {
		...
		_events: {
			...
			_loader: (a, b, c) => any;
			_numListeners: number;
			_player: ReturnType<PlatformAutoGen["getAudiobooksPremiumConsumptionCapObserverAPI"]>["_playerApi"]["_contextPlayer"];
	...
	getPlaybackAPI: () => {
		...
		_filters: {
			...
			getSavedDevices: () => ReturnType<PlatformAutoGen["getAdManagers"]>["adStateReporter"]["focusState"]["listeners"];
		...
		_transport: ReturnType<PlatformAutoGen["getAudiobooksPremiumConsumptionCapObserverAPI"]>["_playerApi"]["_collection"]["transport"];
		_volume: number;
		emitVolume: () => any;
		getCapabilities: () => {
			canChangeVolume: boolean;
	...
	getRemoteConfiguration: () => ReturnType<PlatformAutoGen["getAudiobooksPremiumConsumptionCapObserverAPI"]>["_showApi"]["remote_configuration"];
	getReportAPI: () => {
	...
	getRequestBuilder: () => ReturnType<PlatformAutoGen["getAdManagers"]>["hpto"]["hptoApi"]["webApi"]["spotifyTransport"];
	getRootlistAPI: () => {
		_builder: ReturnType<PlatformAutoGen["getAdManagers"]>["hpto"]["hptoApi"]["webApi"]["spotifyTransport"];
		_cache: Set<any>;
	...
	getSettingsAPI: () => {
		language: {
			...
			identifier: string;
			key: string;
			prefsApi: ReturnType<PlatformAutoGen["getAudiobooksPremiumConsumptionCapObserverAPI"]>["_playerApi"]["_prefs"];
		...
		quality: {
			...
			maxSupportedQuality: ReturnType<PlatformAutoGen["getSettingsAPI"]>["quality"]["downloadAudioQuality"]["maxSupportedQuality"];
			normalizeVolume: {
				deserializeValue: (a) => any;
				getValue: () => Promise<any>;
				identifier: string;
	...
	getShuffleAPI: () => {
		_contextualShuffle: ReturnType<PlatformAutoGen["getAudiobooksPremiumConsumptionCapObserverAPI"]>["_playerApi"]["_contextualShuffle"];
		_events: {
			_emitter: ReturnType<PlatformAutoGen["getAdManagers"]>["hpto"]["hptoApi"]["eventSender"]["transport"]["_pluginMediator"];
			addListener: ReturnType<
				PlatformAutoGen["getAudiobooksPremiumConsumptionCapObserverAPI"]
		...
		_playlistDataServiceClient: ReturnType<PlatformAutoGen["getCurationAPI"]>["_playlistAPI"]["_events"]["_dataClient"];
		_playlistServiceClient: ReturnType<
			PlatformAutoGen["getAudiobooksPremiumConsumptionCapObserverAPI"]
		>["_playerApi"]["_playlistResyncerAPI"]["_playlistServiceClient"];
		_smartShuffleEligibility: ReturnType<PlatformAutoGen["getAudiobooksPremiumConsumptionCapObserverAPI"]>["_playerApi"]["_smartShuffleEligibility"];
		_syncShuffle: (a) => any;
		_userApi: {
			_cosmos: ReturnType<PlatformAutoGen["getAudiobooksPremiumConsumptionCapObserverAPI"]>["_playerApi"]["_cosmos"];
			_events: {
	...
	getUBILogger: () => {
		...
		ubiLogger: {
			...
			pageUriProvider: {
				getPageUri: () => any;
				setPageUri: () => any;
				storageManager: ReturnType<PlatformAutoGen["getUBILogger"]>["ubiLogger"]["pageInstanceIdProvider"]["storageManager"];
			};
			pageViewLogger: {
				addEventListeners: () => any;
				authenticationProvider: ReturnType<PlatformAutoGen["getUBILogger"]>["ubiLogger"]["authenticationProvider"];
				...
				logClientGainedFocus: () => any;
				logClientLostFocus: () => any;
				pageInstanceIdProvider: ReturnType<PlatformAutoGen["getUBILogger"]>["ubiLogger"]["pageInstanceIdProvider"];
